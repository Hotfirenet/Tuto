...
/***************************************************************************
  ...
  must be created.
****************************************************************************/
char VTempA[5], VLightA[5], VGazA[5], VHumiD[5], VTempD[5], VBaroI2C[5], VTempI2C[5];

void HTTPPrint_VTempA() {
	TCPPutString(sktHTTP,(BYTE *)VTempA);
}

void HTTPPrint_VLightA() {
	TCPPutString(sktHTTP,(BYTE *)VLightA);
}

void HTTPPrint_VGazA() {
	TCPPutString(sktHTTP,(BYTE *)VGazA);
}

void HTTPPrint_VHumiD() {
	TCPPutString(sktHTTP,(BYTE *)VHumiD);
}

void HTTPPrint_VTempD() {
	TCPPutString(sktHTTP,(BYTE *)VTempD);
}

void HTTPPrint_VBaroI2C() {
	TCPPutString(sktHTTP,(BYTE *)VBaroI2C);
}

void HTTPPrint_VTempI2C() {
	TCPPutString(sktHTTP,(BYTE *)VTempI2C);
}
